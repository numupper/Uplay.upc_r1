...
internal class Party
{
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_DisablePartyMemberMenuItem), []);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_EnablePartyMemberMenuItem), []);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_GetFullMemberList), [aOutMemberList]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_GetId), []);
        return 0;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_GetInGameMemberList), [aOutMemberList]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_Init), [aFlags]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_InvitePartyToGame), [aOverlapped]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_InviteToParty), [aAccountIdUtf8, aOverlapped]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_IsInParty), [aAccountIdUtf8]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_IsPartyLeader), [aAccountIdUtf8]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_PromoteToLeader), [aAccountIdUtf8, aOverlapped]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_RespondToGameInvite), [aInvitationId, aAccept]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_SetGuest), [guestId, aOverlapped]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_SetUserData), [aDataBlob]);
        return true;
    }
    ...
    {
        Log.Information(nameof(UPLAY_PARTY_ShowGameInviteOverlayUI), [aInvitationId]);
        return false;
    }
}
