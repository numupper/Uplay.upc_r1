...
internal class Win
{
    ...
    {
        Log.Information(nameof(UPLAY_WIN_GetActions), [aOutActionList, aOverlapped]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_WIN_GetRewards), [aOutRewardList, aOverlapped]);
        return false;
    }
    ...
    {
        Log.Information(nameof(UPLAY_WIN_RefreshActions), []);
        return true;
    }
    ...
    {
        Log.Information(nameof(UPLAY_WIN_ReleaseActionList), [aActionList]);
        return true;
    }
    ...
    {
        Log.Information(nameof(UPLAY_WIN_ReleaseRewardList), [aRewardList]);
        return true;
    }
